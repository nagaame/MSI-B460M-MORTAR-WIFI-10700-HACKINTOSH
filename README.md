...
![GitLab tag (latest by date)](https://img.shields.io/github/v/tag/nagaame/MSI-B460M-MORTAR-WIFI-10700-HACKINTOSH)
...
- 这块主板HDMI接口不支持4K/60Hz, 只有4K/30Hz, 只有DP接口支持4K/60Hz
